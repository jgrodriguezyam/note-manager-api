/* Using Database sqlserver2008 and Connection String Server=JRODRIGUEZ-PC\SQLEXPRESS; Database=NoteManager; User Id=sa; Password=********; */
...
/* CreateTable Company */
CREATE TABLE [dbo].[Company] ([Id] INT NOT NULL IDENTITY(1,1), [Name] NVARCHAR(250) NOT NULL, [Address] NVARCHAR(250) NOT NULL, [Colony] NVARCHAR(250) NOT NULL, [City] NVARCHAR(250) NOT NULL, [Rfc] NVARCHAR(250) NOT NULL, [OfficePhone] NVARCHAR(250), [OfficeCellPhone] NVARCHAR(250), [Date] DATE NOT NULL, [CreatedBy] INT NOT NULL, [ModifiedBy] INT NOT NULL, [CreatedOn] DATETIME NOT NULL, [ModifiedOn] DATETIME NOT NULL, [IsActive] BIT NOT NULL, CONSTRAINT [PK_Company] PRIMARY KEY ([Id]))
...
INSERT INTO [dbo].[VersionInfo] ([Version], [AppliedOn], [Description]) VALUES (1, '2017-08-22T00:00:43', '_1_Seed')
/* Committing Transaction */
/* 1: _1_Seed migrated */
